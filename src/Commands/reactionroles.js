...
module.exports = class ReactionRoles extends cmds {
    ...
    async run(msg) {
        ...
        msg.s(
            "Hai! So, you wanna setup a reaction role with me? Nice! First of all, I need a channel ID so i'll be able to fetch a messge from it. **Please provide one in the next minute**\n\nHow to grab an ID: https://support.discord.com/hc/en-us/articles/206346498-Where-can-I-find-my-User-Server-Message-ID-"
        );
    ...
    async c2(msg, collectedmessage) {
        msg.s(
            "Perfect, i found the message! Now, you have to tell me, in this order: ``:emoji: roleid`` in the next 60 seconds. If you wanna add multiple reactions to this message, you will have to re run this command."
        );
